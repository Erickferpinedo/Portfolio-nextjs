      ...
      <div>
        <div className="flex flex-col md:flex-row lg:flex-row justify-center items-center py-6">
          <h2 className="mb-5 mt-5">
            {" "}
            <small className="font-medium text-lg text-gray-500 dark:text-gray-400"></small>
            Get In Touch
          </h2>
        </div>
        <div className="flex flex-col md:flex-row lg:flex-row justify-center items-center pb-6">
          <h3 className="text-4xl font-bold dark:text-white mb-3" id="Contact">
            Contact Me
          </h3>
        </div>
      </div>

      <div className=" details-container p-6 flex-1  p-4 md:p-6 pl-4 md:pl-6 rounded-2xl border border-gray-300 text-center mt-4 md:mt-2 md:mr-2 justify-between ">
        <div className="p-6 md: flex flex-col md:flex-row lg:flex-row justify-between py-3">
          <div className="flex items-center mb-2 md:mb-0 dark:text-white mt-5">
            ...
            <a href="mailto:erickfprogrammer@gmail.com" className="">
              erickfprogrammer@gmail.com
            </a>
          </div>
